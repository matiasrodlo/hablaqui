...
const createPlan = async ({ payload }) => {
  ...
  if (foundCoupon && foundCoupon.discountType === 'static') { price = payload.originalPrice }
  ...
  ) { return conflictResponse('El usuario ya tiene un plan vigente') } else {
...
const createSession = async (userLogged, id, idPlan, payload) => {
  ...
  if (myPlan.payment !== 'success') { return conflictResponse('No puedes agendar un plan sin pagar') }
