...
const psychologistsController = {
  ...
  async getFormattedSessions(req, res) {
    try {
      ...
      const { data, code } = await psychologistsService.getFormattedSessions(
        idPsychologist
      );
      return restResponse(data, code, res);
    } catch (error) {
  ...
  async getByUsername(req, res) {
    try {
      ...
      const { data, code } = await psychologistsService.getByUsername(username);
      return restResponse(data, code, res);
    } catch (e) {
  ...
  async updatePaymentMethod(req, res) {
    try {
      const { user } = req;
      const { payload } = req.body;
      const { data, code } = await psychologistsService.updatePaymentMethod(
        user,
        payload
      );
      return restResponse(data, code, res);
  ...
  async updatePsychologist(req, res) {
    try {
      ...
      const { data, code } = await psychologistsService.updatePsychologist(
        user,
        profile
      );
      return restResponse(data, code, res);
  ...
  async deleteOne(req, res) {
    try {
      const { user } = req;
      const { id } = req.params;
      const { data, code } = await psychologistsService.deleteOne(user, id);
      return restResponse(data, code, res);
    } catch (e) {
  ...
  async getRating(req, res) {
    try {
      const { psychologist } = req.params;
      const { data, code } = await psychologistsService.getRating(psychologist);
      return restResponse(data, code, res);
    } catch (e) {
  ...
  async searchClients(req, res) {
    try {
      ...
      const { data, code } = await psychologistsService.searchClients(search);
      return restResponse(data, code, res);
    } catch (e) {
  ...
  async updateFormationExperience(req, res) {
    try {
      ...
      const { user } = req;
      const { data, code } =
        await psychologistsService.updateFormationExperience(user, payload);
      return restResponse(data, code, res);
    } catch (e) {
  ...
  async approveAvatar(req, res) {
    try {
      const { user } = req;
      const { id } = req.params;
      const { data, code } = await psychologistsService.approveAvatar(user, id);
  ...
  async uploadProfilePicture(req, res) {
    try {
      ...
      const { file } = req;
      const { data, code } = await psychologistsService.uploadProfilePicture(
        id,
        file
      );
      return restResponse(data, code, res);
