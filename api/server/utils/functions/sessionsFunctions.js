...
export const setSession = (role, sessions) => {
  return sessions.flatMap(item => {
    ...
    return item.plan.flatMap(plan => {
      if (plan.title === 'Mensajería y videollamada') { plan.title = 'sesion online' } else if (plan.title === 'Acompañamiento vía mensajería') { plan.title = 'sesion online' } else if (plan.title === 'Sesiones por videollamada') { plan.title = 'sesion online' }
