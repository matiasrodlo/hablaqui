<template>
  <div style="background-color: #f0f8ff">
    ...
    <div
      :class="
        !matchedSpecialists.length && !dialogPrecharge
          ? 'primary'
          : 'trasnparent'
      "
    >
      ...
      >
        ...
        <div
          class="d-flex justify-center text-h7 mb-12 mx-auto"
                  ...
                  <v-stepper-items>
                        ...
                        <v-col>
                          <template v-for="(item, i) in specialties">
                            <v-btn
                              ...
                              :key="i"
                              :color="
                                themes.includes(item) ? 'primary' : '#BDBDBD'
                              "
                    ...
                    <v-stepper-content step="5">
                      ...
                      <v-btn
                        class="pa-2 my-4"
                        :color="
                          models.includes('Integrativo') ? 'primary' : '#BDBDBD'
                        "
                      ...
                      <v-btn
                        class="pa-2 my-4"
                        :color="
                          models.includes('Contextual') ? 'primary' : '#BDBDBD'
                        "
                      ...
                      <v-btn
                        class="pa-2 my-4"
                        :color="
                          models.includes('Humanista') ? 'primary' : '#BDBDBD'
                        "
                      ...
                      <v-btn
                        class="pa-2 my-4"
                        :color="
                          models.includes('Sistémico') ? 'primary' : '#BDBDBD'
                        "
...
export default {
  ...
  methods: {
    ...
    openPrecharge() {
      ...
      const gender =
        this.genderConfort === 'Me es indiferente' ? '' : this.genderConfort
      const payload = {
        gender,
        themes: this.themes,
