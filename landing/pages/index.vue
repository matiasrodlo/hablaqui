  ...
  <div>
        ...
        >
          ...
          >
            ...
            <div class="title mt-10 mb-7">
              ...
              forma segura y privada con un especialista online cuando lo
              necesites.
            </div>
            <v-btn
            ...
            <div class="body-1 font-weight-bold mt-7">
    ...
    <v-container tag="section" class="pt-md-10" fluid style="max-width: 1080px">
      <v-row tag="section" justify="center">
        ...
        >
          Es fácil y seguro realizar terapia con un especialista online y
          continuar con tu estilo de vida con Hablaquí.
        </v-col>
      </v-row>
      <v-row tag="section" justify="center">
        <v-col
        ...
        <v-row tag="section" justify="space-between" align="center">
          ...
          >
            ...
            <article class="my-10 body-1">
              Contamos con un amplio equipo de especialistas enfocados a
              potenciar el área que busques desarrollar. Todos nuestros
              profesionales son rigurosamente seleccionados, certificados, y
              cuentan con un alto nivel de formación y experiencia. Te
              garantizamos una atención efectiva y experta, pero también cálida
              y humana.
            </article>
            <v-btn
          ...
          <v-col tag="section" cols="12" md="6" class="d-flex justify-center">
            <section
              style="box-shadow: 22px 22px 0px 0px #b2eceb; border-radius: 25px"
            >
              <v-carousel
                cycle
                        ...
                        <div>
                          <v-row>
                            <v-col cols="1" class="ml-4">
                              <icon color="primary" :icon="mdiCheck" />
                            </v-col>
                            <v-col
          ...
          <v-col
            tag="section"
            cols="12"
            class="hidden-md-and-up my-10 text-center"
          >
            <v-btn
              id="ver-mar-2"
              style="border-radius: 15px"
    ...
    <v-container tag="section">
      <v-row tag="section">
        ...
        >
          Comienza tu viaje de autoconocimiento y desarrollo personal ahora
          mismo
        </v-col>
      </v-row>
    </v-container>
...
export default {
  ...
  data() {
    return {
      ...
      firstbox: [
        ...
        {
          id: 2,
          title: 'Agenda la hora y día de tu consulta',
          desc: 'Agenda con total libertad cuando te resulte más conveniente.',
        },
        {
          id: 3,
          title: 'Disfruta de tu primera sesión en línea',
          desc: 'Conéctate por videollamada desde tu teléfono, tableta o computadora.',
        },
      ],
      ventajas: [
        {
  ...
  jsonld() {
    return {
      ...
      '@type': 'Organization',
      name: 'Hablaqui',
      url: this.$config.API_ABSOLUTE,
      logo: this.$config.API_ABSOLUTE,
      description:
  ...
  head() {
    ...
    const canonical = `${this.$config.API_ABSOLUTE}${pathWithSlash}`
    return {
