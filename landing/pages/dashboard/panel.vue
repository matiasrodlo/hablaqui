      ...
      <v-card v-if="selected" max-width="1200px">
        ...
        <v-card-text class="mt-3">
          ...
          <v-row>
            ...
            <v-col cols="4" class="br bb bt py-2">
              <textarea
                v-model="selected.personalDescription"
                rows="3"
              ></textarea>
            </v-col>
            <!-- linkedin -->
          ...
          <v-row v-if="selected.isSpec">
            ...
            <v-col cols="4" class="br bb bt py-2">
              <select
                ...
                type="text"
                @change="
                  (e) => (selected.paymentMethod.accountType = e.target.value)
                "
              >
                <option
                  v-for="(item, i) in [
          ...
          <v-row>
              ...
              >
                ...
                <v-col cols="2" class="br bb bt">
                  <input
                    ...
                    :value="item.end"
                    @input="
                      (e) => (selected.experience[i].end = e.target.value)
                    "
                  />
                </v-col>
              ...
              >
                <v-col cols="3" class="bl br bb bt">
                  <select
                    ...
                    @change="
                      (e) =>
                        (selected.formation[i].formationType = e.target.value)
                    "
                  >
                    <option
                      v-for="(el, k) in [
                ...
                <v-col cols="2" class="br bb bt">
                  <input
                    ...
                    :value="item.start"
                    @input="
                      (e) => (selected.formation[i].start = e.target.value)
                    "
                  />
                </v-col>
                <v-col cols="2" class="br bb bt">
            ...
            <v-col v-if="!selected.isSpec" cols="12">
              ...
              <br />
              ¿Cuántos años ha visto pacientes en línea a través de consultas
              por video? {{ selected.yearsExpVideocalls }}
              <br />
              ...
              <br />
              ¿Está actualmente bajo la supervisión clínica de otro profesional
              de la psicología? {{ selected.isUnderSupervision ? 'Si' : 'No' }}
              <br />
        ...
        >
          Recuerda antes de aprobar dar al boton actualizar y tambien recuerda
          verificar el username que este disponible
        </div>
...
export default {
  ...
  methods: {
    ...
    async initFetch() {
      ...
      let banks = await fetch(`${this.$config.VUE_URL}/bancos.json`)
    ...
    async uploadAvatar(file) {
      ...
      const index = this.specialists.findIndex(
        (element) => element._id === specialist._id
      )
