    ...
    <v-container fluid style="height: 100vh; max-width: 1200px">
      ...
      <v-row align="start">
        ...
        <v-col
          ...
          :style="
            step && step.title === 'Consultante nuevo' ? 'z-index: 3' : ''
          "
        >
          <!-- <span
						v-if="
        ...
        <v-col cols="12">
          <v-data-table
            ...
            @click:row="
              (e) =>
                $router.push(
                  `consultantes/consultante-seleccionado?id=${e._id}`
                )
            "
          >
          ...
          <v-card
            ...
            @click="
              () =>
                $router.push(
                  `consultantes/consultante-seleccionado?id=${item._id}`
                )
            "
          >
            <v-card-text>
      ...
      >
        <v-card min-height="300" width="650" rounded="lg">
          ...
          <v-card-text class="pt-3">
            <p>
              Concéntrese en atender a sus consultantes y déjenos la burocracia
              a nosotros.
            </p>
            <p>
              El tiempo que gasta en agendar, confirmar su asistencia y cobrar,
              ahora lo podrá usar para enfocarse en tu carrera o simplemente ver
              Netflix.
            </p>
            <p>
              Ingresar a sus consultantes es muy simple y lo mejor: cobramos 0%
              de comisión. De esta forma estara asegurando organización y
              practicidad en sus actividades diarias, además de optimizar sus
              tiempos y dinero.
            </p>
