		...
		<v-container class="mt-16">
			<v-row justify="center">
				<v-col cols="12" md="10">
					...
					los usuarios ("Usuarios") las condiciones esenciales para la utilización de los
					...
					<br /><br />
					Hablaquí es una plataforma de contenidos, gestión de citas, pagos y consultas
					virtuales que ofrece a los Usuarios buscar y programar citas con los
					Profesionales debidamente registrados en la Plataforma.
					<br /><br />
					La Plataforma proporciona un entorno virtual desarrollado exclusivamente para el
					cuidado de la salud emocional y el asesoramiento especializado, a través del
					cual es posible que los Usuarios y los Profesionales presten servicios en línea,
					garantizando la confidencialidad y la privacidad requeridas por el Código de
					Ética Profesional de cada segmento.
					<br /><br />
					...
					su método de trabajo, por lo que Hablaquí no será responsable por la
					cancelación, retraso, cambio de fecha u horario del servicio o cualquier otro
					daño moral o material al Usuario, al que no haya dado justa causa.
					<br /><br />
					Todos los pagos deben realizarse mediante tarjeta de crédito, paypal, giro
					bancario o transferencia bancaria a la cuenta de Hablaquí por medio de la
					plataforma Hablaquí.
					<br /><br />
					...
					Hablaquí.
					<br /><br />
					Por motivos de seguridad y para garantizar los servicios de la Plataforma,
					Hablaquí no recomienda a los Usuarios realizar el pago directamente al
					Profesional, por ejemplo, mediante ingreso bancario en cuenta corriente. En
					estos casos, Hablaquí no será responsable de los daños y perjuicios sufridos por
					la parte perjudicada, ni siquiera los que estén en desacuerdo con las presentes
					Condiciones y Política de Privacidad.
					<br /><br />
					En caso de que el Usuario se sienta incómodo con la sugerencia del Especialista
					de utilizar medios de pago alternativos, en desacuerdo con los presentes
					Términos de Uso y Política de Privacidad, el Usuario deberá comunicarse
					inmediatamente con Hablaquí para que lo asista y se tomen las medidas
					necesarias.
					<br /><br />
					...
					Plataforma, a su sola discreción y en cualquier momento, notificando al Usuario
					con antelación cualquier modificación.
					<br /><br />
					Al registrarse, el Usuario podrá utilizar todos los servicios disponibles en la
					Plataforma para la región del Usuario, declarando, para ello, haber leído,
					comprendido y aceptado las Condiciones.
					<br /><br />
					El Profesional se compromete a proporcionar el 100% de los productos disponibles
					en la Plataforma.
				</v-col>
				<v-col cols="12" md="10">
					<strong>Capacidad civil para el registro en la Plataforma</strong> <br />
					<br />
					Los servicios de la Plataforma solo están a disposición de las personas capaces
					de ejercer personalmente los actos de la vida civil. El uso por parte de los
					menores de 18 años está sujeto a la autorización, el nombre completo, el RUT y
					la fecha de nacimiento de los padres o el tutor legal del menor enviados a
					través del servicio de atención al usuario. Al acceder, utilizar o crear una
					cuenta en Hablaquí, usted asegura que es capaz de ejercer personalmente los
					actos de la vida civil y que conoce las sanciones legales previstas en el Código
					Civil.
					<br /><br />
					Está prohibida la creación de más de un registro por Usuario. En caso de que un
					mismo usuario realice varios registros, Hablaquí se reserva el derecho de
					desactivar y eliminar el registro sin previo aviso.
				</v-col>
				<v-col cols="12" md="10">
					<strong>Registro</strong> <br /><br />
					Los usuarios deben registrarse directamente en la Plataforma rellenando la
					información personal solicitada por Hablaquí.
					<br />
					<br />
					Al crear una cuenta en Hablaquí, el Usuario se responsabiliza y se compromete a
					facilitar únicamente información veraz, exacta y auténtica y a mantenerla
					actualizada mientras utilice la Plataforma o los servicios de Hablaquí. Los
					Usuarios de Hablaquí garantizan y responden, en cualquier caso, civil y/o
					...
					de uso no autorizado de su cuenta. El Usuario será el único responsable de las
					operaciones realizadas en su cuenta, ya que el acceso solo es posible mediante
					el uso de un sistema de verificación exclusivo de su cuenta.
					<br />
					<br />
					Estos términos incluyen, pero no se limitan a, el uso de las funcionalidades
					"recordar contraseña" o "mantenerme conectado" en ordenadores o dispositivos
					móviles propios o de terceros.
					<br />
					<br />
					En ningún caso podrá ceder, vender, alquilar o transferir su cuenta. No está
					permitida, además, la creación de nuevos registros por parte de personas cuyos
					registros originales hayan sido cancelados por violaciones de las políticas de
					Hablaquí.
				</v-col>
				<v-col cols="12" md="10">
					<strong>Formas de servicio </strong>
					<br /><br />
					Los servicios pueden prestarse por separado o a través de planes contratados por
					el usuario. <br /><br />
					Los servicios únicos incluyen el pago solo por el valor del servicio disponible
					en la Plataforma según la especialidad y el profesional seleccionado.
					<br /><br />
					Todos los planes incluyen un 10% de descuento en todas las citas con cualquier
					profesional, destacando que la renovación de este es automática y se realizará
					cada 30 días.
					<br /><br />
					El Usuario se reserva el derecho de proceder a la cancelación del plan en
					cualquier momento, sin aplicación de valores a modo de multa por fidelidad.
					<br /><br />
					El pago de los planes se realiza exclusivamente con Tarjeta de Crédito, por lo
					que Hablaquí no se reserva el derecho de no proceder a la reversión de los
					valores que puedan ser cobrados por incumplimiento del Usuario respecto a la
					renovación automática del plan.
				</v-col>
				<v-col cols="12" md="10">
					<strong> Programación de citas </strong> <br /><br />
					Hablaquí ofrece un servicio para gestionar la programación y el pago de las
					citas virtuales con los profesionales. Se destaca que Hablaquí no gestiona la
					disponibilidad de los Profesionales. Por lo tanto, toda la información sobre la
					fecha, la hora y el lugar son responsabilidad exclusiva del profesional.
					<br />
					<br />
					Teniendo en cuenta los criterios de información elegidos por el Usuario, se
					presentará una lista de Profesionales, indicando los días y horarios
					disponibles, así como el importe a cobrar por el servicio.
					<br />
					<br />
					El criterio de ordenación de los Profesionales, en la lista proporcionada
					anteriormente, será definido única y exclusivamente por Hablaquí, a través de un
					algoritmo que podrá tomar en consideración criterios como la especialización, el
					índice de recomendación, el índice de acceso, la escala de evaluación, entre
					otros.
					<br />
					<br />
					El Usuario, interesado en programar el servicio, deberá manifestarse
					electrónicamente a través de la plataforma Hablaquí, informando si la cita es
					para el propio Usuario o para una tercera persona / o dependiente. En el caso de
					una tercera persona o dependiente, el Usuario deberá informar en la propia
					plataforma, los contactos de esta persona y demás información necesaria para que
					el Usuario pueda participar en el servicio. Hablaquí no es responsable de la
					veracidad, exactitud, autenticidad o actualización de los datos informados.
					<br />
					<br />
					Al final, el Usuario debe elegir uno de los métodos de pago disponibles en la
					plataforma: tarjeta de crédito, paypal, transferencia bancaria, bono o
					asociación y hacer clic en "Programar".
					<br />
					<br />
					Hay que tener en cuenta que en los casos de pago a través de transferencia
					bancaria el Usuario debe realizar la transacción en un día laborable aunque la
					consulta virtual se realice en fin de semana.
					<br />
					<br />
					Tras la confirmación de la cita, el horario elegido por el Usuario no estará
					disponible para otros Usuarios, garantizando así la no acumulación de citas a la
					misma hora para el mismo profesional.
					<br />
					<br />
					Hablaquí no recomienda que las citas virtuales se realicen a través de otras
					plataformas de comunicación, debido a la falta de protocolos específicos de
					seguridad y confidencialidad necesarios para el mantenimiento de la relación
					entre Profesionales y Usuario. Si las partes utilizan otra plataforma de
					comunicación, Hablaquí no será responsable de las pérdidas y daños sufridos por
					la parte perjudicada.
					<br />
					<br />
					El Usuario que haya concertado citas en nombre de un tercero y/o dependiente
					deberá asegurarse de que el tercero y/o dependiente esté debidamente registrado
					para recibir, en su correo electrónico, un enlace para acceder a la fecha y hora
					programada en la Oficina Virtual de Hablaquí. Hablaquí no es responsable de las
					pérdidas y daños sufridos por la parte perjudicada.
					<br />
					<br />
					...
					exclusiva de la parte que lo haya provocado, por lo que Hablaquí no se
					responsabiliza de los daños y perjuicios sufridos por la parte afectada por el
					retraso.
				</v-col>
				<v-col cols="12" md="10">
					<strong>Política de cambios</strong> <br /><br />
					El Usuario podrá modificar el horario del servicio sin coste alguno, siempre que
					lo haga con la antelación mínima que cada profesional requiera y quede explícito
					en la página de cada profesional, directamente en la Plataforma.
					<br />
					<br />
					...
					cobrado por el servicio se repercutirá al profesional que puso a disposición la
					hora de la cita, descontando la cuota de servicio de Hablaquí, no siendo
					reembolsado importe alguno al Usuario.
					<br />
					<br />
					Hablaquí se reserva el derecho de revisar en cualquier momento las políticas de
					reprogramación añadiendo limitaciones a la misma.
				</v-col>
				<v-col cols="12" md="10">
					<strong>Retirada de la ayuda</strong> <br />
					<br />
					El Usuario puede renunciar al servicio, siempre y cuando solicite la cancelación
					del servicio dentro de las 12 (doce) horas anteriores al mismo. El Usuario es
					consciente de que se deducirán del importe a devolver, todas las comisiones que
					se hayan cobrado en la transacción financiera.
					<br />
					<br />
					...
					bancaria o paypal el plazo de devolución será de hasta 10 (diez) días hábiles.
					<br />
					<br />
					Si el Usuario concierta la cita y no se presenta a la hora programada o solicita
					la anulación con menos de 12 (doce) horas de antelación a la hora previamente
					programada, el importe cobrado por el servicio será repercutido al profesional
					que puso a disposición la hora de la cita, no siendo devuelto importe alguno al
					Usuario.
					<br />
					<br />
					Si el Profesional, por cualquier motivo, necesita reprogramar la cita, se pondrá
					en contacto con el Usuario, a través de la Plataforma, para indicarle otra hora
					que tenga disponibilidad. El Usuario deberá devolver el contacto, informando si
					está de acuerdo con la reprogramación o si desea cancelar la cita. Si el Usuario
					no está de acuerdo con el cambio de horario, Hablaquí podrá indicar otro
					profesional o realizar el reembolso del importe total al Usuario.
					<br />
					<br />
					En caso de no presentarse el Profesional en el servicio programado, el importe
					cobrado podrá ser utilizado para la programación de un nuevo servicio o será
					devuelto en su totalidad al Usuario.
				</v-col>
				<v-col cols="12" md="10">
					<strong>Evaluación del profesional</strong> <br />
					<br />
					Hablaquí pone a disposición de los Usuarios una herramienta de evaluación
					subjetiva de sus Especialistas, con el fin de contribuir a la calidad de los
					...
					comentarios, debiendo ceñirse a los hechos, describiendo su opinión de forma
				...
				<v-col cols="12" md="10">
					<strong>Renuncias y limitaciones de responsabilidad de Hablaquí</strong>
					<br /><br />
					...
					los Servicios y el Contenido. <br /><br />
					...
					<br /><br />
					c) cesar, ver y supervisar todo el contenido publicado o transmitido por el
					...
					<br /><br />
					Hablaquí está facultado para proceder al traspaso de los informes emocionales
					aportados por los Profesionales al finalizar el servicio, en los casos de
					Usuario procedente de un producto Corporativo.
					<br /><br />
					Hablaquí no avala a ningún Profesional y no tiene responsabilidad alguna por la
					conducta de los Profesionales o de terceros contactados o contratados a través
					de la Plataforma. Hablaquí no se responsabiliza explícitamente de cualquier acto
					u omisión de cualquier Experto en relación con los Usuarios o terceros. Al
					utilizar la Plataforma o los Servicios, usted acepta que cualquier acción legal
					o de responsabilidad que intente obtener por las acciones u omisiones de los
					Profesionales, Usuarios u otros terceros se limitará a una reclamación contra
					los Profesionales, Usuarios individuales o terceros que le hayan causado alguna
					insatisfacción y acepta no intentar hacer valer la responsabilidad o interponer
					un recurso legal contra Hablaquí, o sus accionistas, representantes, directivos
					o empleados, con respecto a dichas acciones u omisiones. El mismo compromiso se
					aplica a todas las demás partes implicadas en las reclamaciones o acciones.
					<br /><br />
					Al no figurar Hablaquí como parte en las transacciones que se produzcan entre
					Usuarios y Expertos, la responsabilidad de todas las obligaciones derivadas de
					las mismas, ya sean fiscales, laborales, de consumo o de cualquier otra índole,
					son exclusivamente de los Usuarios y Expertos.
					<br /><br />
					Si Hablaquí es la parte demandada en un pleito cuyos hechos se basan en acciones
					del Usuario y/o Profesional, el Usuario y/o Profesional será llamado a la parte
					demandada y deberá soportar todas las cargas resultantes de la misma.
					<br /><br />
					...
					aprobación o solidaridad de Hablaquí hacia dichos sitios web, sus contenidos,
					...
					Plataforma;
					<br /><br />
					b) Cualquier daño directo o indirecto causado por hechos de terceros, tales como
					ataques de hackers, fallos en el sistema, en el servidor o en la conexión a
					...
					Privacidad del portal accedido y actuar en consecuencia;<br /><br />
					<br /><br />
				...
				<v-col cols="12" md="10">
					...
					indemnizar a los afectados por los daños causados. <br /><br />
					...
					<br /><br />
					a) Molestar, agredir, calumniar, difamar, perseguir o acosar de cualquier manera
					a otro Usuario o Socio.
					<br /><br />
					b) Vulnerar los derechos de cualquier persona o entidad, incluyendo, sin
					limitación, los derechos de propiedad intelectual, privacidad, publicidad o
					contractuales, señalando que está prohibida la grabación por vídeo o voz de los
					...
					funcionalidades, planes o forma de pago utilizados por la Plataforma. En caso de
					incumplimiento de cualquiera de los ítems enumerados anteriormente, Hablaquí no
				...
				<v-col cols="12" md="10">
					...
					se compromete a tomar todas las medidas razonables para no perjudicar al
					Profesional o a los Usuarios. <br /><br />
					El Usuario podrá solicitar la cancelación de su Cuenta de Hablaquí en la propia
					Plataforma, siempre que no tenga obligaciones pendientes con respecto a Hablaquí
					o a los Profesionales, incluyendo, pero sin limitarse a: (i) las asistencias
					abiertas con los usuarios y (ii) los saldos pendientes de canjear.
					<br /><br />
				...
				<v-col cols="12" md="10">
					...
					Experto considere oportuno, directamente en su Plataforma, a través de la página
					web http://www.hablaqui.com o a través del correo electrónico:
					ayuda@hablaqui.com. Al utilizar este canal, el Usuario deberá identificarse con
					los datos pertinentes (nombre, dirección, teléfono y correo electrónico) y
					describir detalladamente la situación, para que Hablaquí pueda verificar las
					medidas aplicables previstas en estas Condiciones.
				</v-col>
				<v-col cols="12" md="10">
					...
					correo electrónico informada por el Usuario en Su Cuenta.
					<br /><br />
